                  ...
                  child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Expanded(child: Column(children: [
                      Stack(children: [
                        ...
                        isStore ? const SizedBox() : Positioned(bottom: 10, right: 10, child: CartCountView(item: item!, index: index)),
                          ...
                          child: SizedBox(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max ,mainAxisAlignment: MainAxisAlignment.center, children: [
                              ...
                              Wrap(crossAxisAlignment: WrapCrossAlignment.center, children: [
                                ...
                                isStore ? SizedBox(width: Dimensions.paddingSizeSmall) : SizedBox.shrink(),
                                isStore && store?.verifiedSeller == 1 ? Image.asset(Images.verifiedBadge, width: 13, height: 13) : SizedBox.shrink(),
                              ...
                              (isStore ? store!.address != null : item!.storeName != null) ? Row(
                                children: [
                                  Text(
