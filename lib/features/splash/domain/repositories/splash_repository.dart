...
class SplashRepository implements SplashRepositoryInterface {
  ...
  Future<void> setModule(ModuleModel? module) async {
    ...
    apiClient.updateHeader(
      ...
      (module != null && (module.moduleType.toString() == AppConstants.ride) ? addressModel?.rideZoneId
          : (module != null && module.moduleType.toString() == AppConstants.service) ? addressModel?.serviceZoneId
          : null),
      fromModule: true,
    );
    if(module != null) {
