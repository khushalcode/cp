            ...
            Column(children: [
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  const CustomAssetImageWidget(Images.highlightIcon, height: 50, width: 50),
              ...
              CarouselSlider.builder(
                ...
                itemBuilder: (context, index, realIndex) {
                  return advertisementController.advertisementList?[index].addType == 'video_promotion'
                      ? HighlightVideoWidget(advertisement: advertisementController.advertisementList![index])
    ...
    return Container(
      ...
      child: TextHover(
        builder: (hovered) {
          return InkWell(
            onTap: (){
              Get.toNamed(RouteHelper.getStoreRoute(id: advertisement.storeId, page: 'store', slug: 'store_${advertisement.storeId}'),
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  InkWell(
                    onTap: (){
                      Get.toNamed(RouteHelper.getStoreRoute(id: widget.advertisement.storeId, page: 'store', slug: ''),
